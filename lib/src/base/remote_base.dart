...
class RemoteBase {
  ...
  RemoteBase({String pBaseUrl = '', String pToken = ''}) {
  ...
  Future<dynamic> getJsonData(
    ...
    var fullUrl =
        '$baseUrl/$endpoint/$pResource${pQueryParameters != '' ? '$queryParameters?populate=*' : '?populate=*'}';
  ...
  Future<dynamic> postJsonData({required String pBody}) async {
    late final http.Response response;
